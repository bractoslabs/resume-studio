...
export const structureRules: ResumeReviewRule = (document) => {
  ...
  if (document.wordCount > 1200) add({ title: "Resume may be too long", severity: "warning", priority: "should-improve", category: "recruiter-skim", location: "Document", whyItMatters: "Long resumes are harder to skim and may exceed practical page targets.", suggestedFix: "Trim older, repeated, or less relevant bullets.", safeAutoFix: false });
  return issues;
};
