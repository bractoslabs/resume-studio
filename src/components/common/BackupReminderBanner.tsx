...
export const LocalStorageWarningBanner = ({
  onBackup,
  onDismiss,
  onLearnMore,
}: {
  ...
  <section className="local-storage-warning" aria-label="Local browser storage warning">
    <div>
      ...
      <p>
        Your resumes are saved only in this browser. They are not synced to an account. Download a backup before clearing browser data,
        switching devices, or relying on Resume Studio for active applications.
      </p>
      <button className="link-button" onClick={onLearnMore}>
