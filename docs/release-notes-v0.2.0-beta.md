# Resume Studio v0.2.0-beta

Resume Studio is a free, private, Markdown-first resume builder from Bractos Labs. This public beta focuses on local-first resume editing, live preview, Resume Review, Keyword & Fit Check, and browser-based Print / Save as PDF.

## Highlights

- Local-first resume drafting with browser storage
- Markdown editing with live preview
- Resume Review and Keyword & Fit Check tools
...
Resume Studio does not guarantee ATS results, hiring outcomes, or employer ranking.

## Feedback

Use GitHub Issues for bugs, feature requests, import/export problems, and documentation improvements.

For private feedback, email labs@bractos.com.
